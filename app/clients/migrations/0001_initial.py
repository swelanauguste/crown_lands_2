    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('community', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='individual_communities', to='locations.communitylist')),
                ...
                ('quarter', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='individual_quarters', to='locations.quarterlist')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('id_type', models.CharField(choices=[('NATIONAL ID', 'NATIONAL ID'), ('PASSPORT', 'PASSPORT'), ("DRIVER'S LICENCE", "DRIVER'S LICENCE")], max_length=50, verbose_name='Type')),
                ('file', models.FileField(upload_to=clients.models.identification_documents_directory_path)),
